...
const SearchUserResultsPage = () => {
    ...
    const { searchQuery, users, resultsCount, updateSearchQuery, fetchUsers } = useSearch(); // useSearch 훅 사용
    const [searchQueryInput, setSearchQueryInput] = useState(''); // 입력 필드의 검색어 상태
    ...
    useEffect(() => {
        ...
        setSearchQueryInput(query); // 검색어 입력 필드 업데이트
        updateSearchQuery(query); // 검색어 업데이트
        ...
        <div className="search-user-results-page-container">
          ...
          <div className="search-bar-and-sort">
            <div className="search-bar-section">
              <SearchBar initialValue={searchQueryInput} onSearch={handleSearch} />
            </div>
          </div>
